        ...
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-xs-12" style="padding:0;">
                    ...
                    <div class="box">
                        <form method="post" action="{{route('Conteudo.Landing_Page.store')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-object-group"></i> <strong>{{trans('words.lpage.create')}}</strong></h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="imagebackground_superior" name="imagebackground_superior" accept="image/*" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="text_destq_tema" id="text_destq_tema" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="box-footer">
                                <div class="col-sm-4 col-sm-offset-4">
                                    <button type="submit" class="btn btn-block btn-success">
                                        <i class="fa fa-save"></i> {{trans('words.save')}}
                                    </button>
                                </div>
                            </div>
                        </form>
