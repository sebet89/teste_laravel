...
class ConteudoController extends Controller
{
    ...
    public function Show()
    {
        ...
        if($action['permission']==true ? $return = view("Conteudo.$this->url_crud.$this->url_permission", $compact) : $return = redirect('/login')->with('error', 'Acesso Negado!'))
        return $return;
    }
    //------------------------------------------------------------------------------------------------------------------
